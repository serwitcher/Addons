lazyScript.metadata:updateRevisionFromKeyword("$Revision: 762 $")
...
function lazyScript.TooltipClass:GetCachedVal(arg1, arg2, arg3, arg4)
...
function lazyScript.TooltipClass:SetCachedVal(arg1, arg2, arg3, arg4, arg5)
   ...
   ptr[arg[argn - 1]] = arg[argn]
end

function lazyScript.TooltipClass:PointTooltip(where, arg1, arg2)
   local arg = {arg1, arg2}
   local argn = table.getn(arg)
