...
function FindIntelBuff()
	...
	-- end
	-- return false;
	local intelect = dav_UnitHasBuffTexture("player", DSTextures.Buffs.Mage.AI);
	--dav_Print(armor);
	if not intelect then return false; end;
	return intelect;
end
...
function FindFrostBuff()
	...
	-- end
	-- return false;
	local armor = dav_UnitHasBuffTexture("player", DSTextures.Buffs.Mage.FA);
	--dav_Print(armor);
